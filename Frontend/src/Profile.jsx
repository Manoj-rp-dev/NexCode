...
const Profile = () => {
  ...
  return (
    <div className='w-full min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-50 font-sans pb-10 transition-colors duration-500'>
      ...
      <div className='relative overflow-hidden w-[95vw] lg:w-full max-w-7xl mx-auto h-32 md:h-40 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/5 flex items-center pt-10 shadow-lg mb-8'>
